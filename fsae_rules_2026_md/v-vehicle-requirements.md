...
lowest point must be 90 mm or less and the distance to the ground should be 75 mm or less.
a. There must be an opening for measuring the ride height at that point without removing
aerodynamic devices
...
## V.3.2.5 Steering system free play must be less than seven degrees (7°) total measured at the steering
wheel
...
“Figure 8”, or cutout wheels are not permitted.
