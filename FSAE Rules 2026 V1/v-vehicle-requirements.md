...
#### V.1.4.1 Ground clearance must be sufficient to prevent any portion of the vehicle except the tires from touching the ground during dynamic events

#### V.1.4.2 The distance to the ground below the Lower Side Impact Structure ( F.6.4.5, F.7.5.1 ) at its lowest point must be 90 mm or less and the distance to the ground should be 75 mm or less. a. There must be an opening for measuring the ride height at that point without removing aerodynamic devices
...
#### V.4.2.2 Teams using modified lug bolts or custom designs must provide proof that Good Engineering Practices have been followed in their design.
